...
<body>
		...
		<table>
			<thead>
				...
				<tr>
					<td>첨부파일</td>
						<td class="uploadDiv">
							<input type="file" name="uploadFile" id="uploadFile" multiple value="${dto.imgPath}">
						</td>
				</tr>
			</thead>
				<tbody id="mapList">
	...
	<div class="search">
		<input id="address" type="text" placeholder="검색할 주소" value="${dto.address}">
...
// 		$('#mapList').append(mapList);	
	...
	function submitFormWithMapData() {
		...
		// 지도 데이터 가져오기
		var address = $('#mapList tr:nth-child(1) td:nth-child(2)').text();
